					...
					<div class="caption">
						<i class="fa fa-gears"></i> Actualizaci&oacute;n de Registros
					</div>

									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('consulta/update_pacientes'); ?>" method="post" class="horizontal-form">
											<div class="form-body">
<?php
if(isset($message)){ 
if($message == 0){?>
...
?>												
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<i class="fa fa-tablet"></i>
																...
																<input required type="text" class="form-control input-circle-right" placeholder="Cedula" name="cedula" id="cedula" value="<?php echo $id[0]['cedula'] ?>"/>
												...
												<div class="form-group">
														...
														<div class="input-group">
															...
															<input required type="text" class="form-control input-circle-right" placeholder="Nombre" name="nombre" value="<?php echo $id[0]['nombre'] ?>"/>
														</div>
												</div>														
												</div>
													<div class="col-md-3">
												<div class="form-group">
														...
														<div class="input-group">
															...
															<input required type="text" class="form-control input-circle-right" placeholder="Apellido" name="apellido" value="<?php echo $id[0]['apellido'] ?>"/>
														</div>
												</div>														
												</div>	
													<div class="col-md-3">
														<div class="form-group">
															...
															<i class="fa fa-phone"></i>
																...
																<input required type="text" class="form-control input-circle-right" placeholder="Tel&eacute;fono" name="telefono" value="<?php echo $id[0]['telefono'] ?>"/>
															</div>
														</div>
													</div>																							
												</div>
									...
									<span class="help-block"><?php echo form_error('fecha_nac', '<div class="alert alert-danger"><button class="close" data-close="danger" id="eliminar"></button>', '</div>'); ?></span>									
												...
												<div class="form-group">
														...
														<div class="input-group">
															...
															<input required type="email" class="form-control input-circle-right" placeholder="Correo Electr&oacute;nico" name="correo" value="<?php echo $id[0]['correo'] ?>"/>
														</div>
												</div>
												...
												?>
													<option selected value="<?php echo $aseguradora['id_seguros']; ?>"><?php echo $aseguradora['seguros']; ?></option>
																<?php } 
																else {
																?>
									...
									<div class="form-group">
										<label class="control-label">Ultima Fecha del Periodo</label>
											<div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
												...
												<input name="ultimo_p" id="ultimo_p" type="text" class="form-control input-circle-right" readonly value="<?php echo $this->dash->fechanew2($id[0]['ultimo_p']) ?>">
									...
									<div class="col-md-3">
														<div class="form-group">
															...
															<i class="fa fa-forward"></i>
																...
																<input required type="text" class="form-control input-circle-right" placeholder="Direccion" name="direccion" value="<?php echo $id[0]['direccion'] ?>"/>
															</div>
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
															...
															<i class="fa fa-signal"></i>
																...
																<input required type="text" class="form-control input-circle-right" placeholder="Grupo Sangu&iacute;neo" name="g_sanguineo" value="<?php echo $id[0]['g_sanguineo'] ?>"/>
															</div>
														</div>
													</div>											
												</div>
