...
?>										
					...
					<div class="caption">
						<i class="fa fa-gears"></i> Us Ginecologico N# <?php echo $numerocon;?> => Fecha del Estudio <?php echo date("d/m/Y");?>
					</div>

									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('consulta/reg_UsGinecologico'); ?>" method="post" class="horizontal-form">
											<input type="hidden" name="id_us_ginecologico_1" id="id_us_ginecologico_1" value="<?php echo $numerocon;?>">
											<div class="form-body">
<?php
if(isset($message)){ 
if($message == 0){?>
...
?>												
									...
									<div class="form-group">
										...
										<label class="control-label">Indicaci&oacute;n</label>
												<textarea rows="2" class="form-control" placeholder="Indicacion..." name="indicacion"></textarea>
									</div>
													</div>																										
												<div class="col-md-4">
														<div class="form-group">
							...
							<div class="tabbable-custom ">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab_5_1">
												<div class="row">
													<div class="col-md-3">
														...
														<select  name="posicion_u" id="posicion_u" class="form-control select2me" data-placeholder="Selecccione">			
															<option value=""></option>
															<option value="Anteversi&oacute;n">Anteversi&oacute;n</option>
															<option value="Anteversoflexi&oacute;n">Anteversoflexi&oacute;n</option>
															<option value="Indiferente">Indiferente</option>
															<option value="Retroversi&oacute;n">Retroversi&oacute;n</option>
															<option value="Retroversoflexi&oacute;n">Retroversoflexi&oacute;n</option>
														</select>												
														</div>
													</div>
									<div class="col-md-2">
										...
										<input name="utero_l" type="number" class="form-control">
								</div>
									</div>	
									<div class="col-md-2">
										<div class="form-group">
										<label class="control-label">Utero AP</label>
										<input name="utero_ap" type="number" class="form-control">
								</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
										<label class="control-label">Utero Trans</label>
										<input name="utero_trans" type="number" class="form-control">
								</div>
									</div>
									<div class="col-md-3">
														<div class="form-group">
									...
									<div class="col-md-3">
										...
										<input name="endometrio_m" type="number" class="form-control">
								</div>
									</div>													
													<div class="col-md-3">
														<div class="form-group">
														...
														<select  name="fondos" id="fondos" class="form-control select2me" data-placeholder="Selecccione">			
															<option value=""></option>
															<option value="Sin l&iacute;quido libre">Sin l&iacute;quido libre</option>
															<option value="Escaso l&iacute;quido libre">Escaso l&iacute;quido libre</option>
														</select>												
														</div>
													</div>
											</div>																												
                    ...
                    <div class="col-md-6">
														<div class="form-group">
															...
															<option value=""></option>
															<option value="Normal">Normal</option>
															<option value="Multifolicular">Multifolicular</option>
															<option value="Atrofico">Atrofico</option>
														</select>
														<label class="control-label">Longitudinal Ovario Derecho</label>
																<input type="text" class="form-control input-small" name="longitudinal"/>
																<label class="control-label">Transversal Ovario Derecho</label>
																<input type="text" class="form-control input-small" name="transversal"/>
																<label class="control-label">Anteroposterior Ovario Derecho</label>
																<input type="text" class="form-control input-small" name="anteroposterior"/>
													...
													<div class="col-md-6">
														...
														<label class="control-label">Longitudinal Ovario Izquierdo</label>
																<input type="text" class="form-control input-small" name="longitudinal1"/>
																<label class="control-label">Transversal Ovario Izquierdo</label>
																<input type="text" class="form-control input-small" name="transversal1"/>
																<label class="control-label">Anteroposterior Ovario Izquierdo</label>
																<input type="text" class="form-control input-small" name="anteroposterior1"/>
										...
										<label class="control-label">Notas de los Hallazgos</label>
											<div class="input-group">
												...
												<textarea rows="4" class="form-control input-circle-right" placeholder="Notas de los Hallazgos...." name="hallazgos" ></textarea>
									...
									<div class="tab-pane" id="tab_5_3">
										...
										<label class="control-label">Diagnosticos</label>
											<div class="input-group">
												...
												<textarea rows="4" class="form-control input-circle-right" placeholder="Diagnosticos...." name="diagnosticos" ></textarea>
										...
										<label class="control-label">Sugerencias</label>
											<div class="input-group">
												...
												<textarea rows="4" class="form-control input-circle-right" placeholder="Sugerencias...." name="sugerencias" ></textarea>
