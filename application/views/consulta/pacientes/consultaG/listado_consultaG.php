		...
		<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-user"></i> Listado de Consultas Ginecol&oacute;gicas de Primera para <?php echo $id[0]['nombre']." ".$id[0]['apellido']?>
					</div>
				</div>
								<div class="portlet-body">
											<?php $this->load->view('base_template/base_alert'); ?>
		<div class="actions">
			<a href="<?php echo site_url('consulta/nueva_consulta/'.$id[0]['id_paciente']); ?>" class="btn green"><i class="fa fa-plus"></i> Nueva Consulta </a>
